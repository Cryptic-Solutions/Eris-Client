package me.spec.eris.config.files;

import java.io.File;
import java.util.ArrayList;

import me.spec.eris.config.files.filetypes.AltsFile;
import me.spec.eris.config.files.filetypes.BindFile;
import me.spec.eris.config.files.filetypes.TimePlayedFile;
