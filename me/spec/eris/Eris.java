...
public class Eris {
	...
	public static Eris getInstance() { return instance; }
	
	public enum Server { HYPIXEL, CUBECRAFT, MINEPLEX, IRRELLEVANT}
	
	public void setServer(Server server) { this.server = server; }
	
	public Server getServer()  {return server;}
	
	public enum Gamemode { BLITZ, SKYWARS, BEDWARS, PIT, DUELS, UNSPECIFIED }
	
	public void setGameMode(Gamemode gamemode) { this.gamemode = gamemode; }
	
	public Gamemode getGameMode() { return gamemode; }
	
	public static Color getClientColor() { return new Color(255, 0, 0); }
	
	public long getStartTime() { return this.startTime; }

	public void setStartTime(long startTime) { this.startTime = startTime; }

	public void sendNotification(String type, String message) { sendNotification(type, message, 10000); }
	
	private void sendNotification(String type, String message, int duration) { notifications.send(new Notification(type, message, duration)); }
	
	public void tellUser(String message) {
		if (Minecraft.getMinecraft() != null && Minecraft.getMinecraft().thePlayer != null && Minecraft.getMinecraft().theWorld != null) {
			Minecraft.getMinecraft().thePlayer.addChatComponentMessage(new ChatComponentText(EnumChatFormatting.WHITE + "[" + EnumChatFormatting.RED + clientName + EnumChatFormatting.WHITE + "]" + message));
		} else {
