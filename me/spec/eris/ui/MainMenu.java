...
public class MainMenu extends GuiScreen implements GuiYesNoCallback {
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
        ...
        if (Reflector.GuiModList_Constructor.exists()) {
            ...
            this.buttonList.add(this.realmsButton = new GuiButton(69, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, "Alt Manager"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        f = f * 100.0F / (float) (this.fontRendererObj.getStringWidth("Congrats on cracking Eris") + 32);
        GlStateManager.scale(f, f, f);
        this.drawCenteredString(this.fontRendererObj, "Congrats on cracking Eris", 0, -8, -256);
        GlStateManager.popMatrix();
        String s = "Eris";
        ...
        String s2 = "Developed by: Spec, cedo, Vaziak, and auth w/ Credits to: Seb, Cystems, Ice";
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        if (this.func_183501_a()) {
            Method m;
            try {
                m = this.field_183503_M.getClass().getDeclaredMethod("mouseClicked", int.class, int.class, int.class);
                m.setAccessible(true);
                m.invoke(this.field_183503_M, mouseX, mouseY, mouseButton);
