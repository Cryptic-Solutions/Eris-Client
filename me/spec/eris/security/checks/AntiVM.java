...
public class AntiVM {
	...
	public static boolean run() {
		...
		if (!run("wmic computersystem get model", "Model", new String[] {"virtualbox", "vmware", "kvm", "hyper-v"}) || !run("WMIC BIOS GET SERIALNUMBER", "SerialNumber", new String[] {"0"}) || !run("wmic baseboard get Manufacturer", "Manufacturer", new String[] {"Microsoft Corporation"})) return false;
