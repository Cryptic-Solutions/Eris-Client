...
public class ESP extends Module {
    ...
    public NumberValue<Integer> distance = new NumberValue<Integer>("Distance", 15, 1, 20, this, "Distance at which esp is drawn on the victim");
        ...
        if (espEvent instanceof EventEntityRender) {
            ...
            if (players.getValue()) {
                for (Entity e : mc.theWorld.loadedEntityList) {
                    if (e instanceof EntityMob && !(e.getEntityId() == mc.thePlayer.getEntityId())) {
                        EntityMob player = (EntityMob) e;
